...
namespace Harness.Framework
{
    ...
    public static class DeferedServices
    {
        ...
        public static void DependencyProvider(IDomainProvider provider)
        {
            Dependencies = Defered<IDependencyProvider>.Create(
                () => provider.FactoryFor<IDependencyProvider>().Create(),
                yieldOnce: true
            );
        }

        public static void ReflectorInstance(IDomainProvider provider)
        {
            Reflector = Defered<IReflector>.Create(() => provider.Create<IReflector>(), yieldOnce: true);
        }
    }
    ...
    public static class Provider
    {
        ...
        static Provider()
        {
            ...
            DeferedServices.DependencyProvider(Domain);
            DeferedServices.ReflectorInstance(Domain);
        }
