...
namespace System.Composition.Providers.Null {
    public class NullDependencyProvider : IDependencyProvider, IDefaultImplementation<IDependencyProvider> {
        ...
        public IDependencyProvider CreateScope() {
            return default(IDependencyProvider);
        }
