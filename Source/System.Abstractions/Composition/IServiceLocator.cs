...
namespace System.Composition {
     ...
     */
    public interface IDependencyContainer : IServiceLocator, IDisposable
    {
        bool GetImplementation<T>(Action<T> action) where T : IDependencyContainer;
        Task<bool> GetImplementationAsync<T>(Action<T> action) where T : IDependencyContainer;
    }
